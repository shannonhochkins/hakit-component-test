...
import { o as oe, l, K, A, b as o$1, r as re, Q, m } from './index-DNwB73eM.js';
...
function $({
  ...
  const {
    useStore: i
  } = oe(), o = T(null), u = i((t) => t.config), f = i((t) => t.entities), p = i((t) => t.connection), d = l(e.state), _ = x(() => K(e, p, u, f, e.state), [u, p, f, e]), b = e.state === A || e.state === o$1 || d, [c, s] = O(e.state === A), N = async (t) => {
    const a = m(e.entity_id);
    let r;
  ...
  return j(() => {
    o.current || c === (e.state === A) || s(e.state === A);
