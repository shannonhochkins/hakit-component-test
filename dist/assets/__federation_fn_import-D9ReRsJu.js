...
const moduleMap = {'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-CRZoeubB.js', import.meta.url).href),import:true},'@emotion/react':{get:()=>()=>__federation_import(new URL('__federation_shared_@emotion/react-CJ_hrD5_.js', import.meta.url).href),import:true},'@emotion/styled':{get:()=>()=>__federation_import(new URL('__federation_shared_@emotion/styled-BhuMTl2L.js', import.meta.url).href),import:true},'@hakit/core':{get:()=>()=>__federation_import(new URL('__federation_shared_@hakit/core-Ddy4EgQF.js', import.meta.url).href),import:true},'@hakit/components':{get:()=>()=>__federation_import(new URL('__federation_shared_@hakit/components-Dbv-4kkn.js', import.meta.url).href),import:true},'uuid':{get:()=>()=>__federation_import(new URL('__federation_shared_uuid-dw_93kd-.js', import.meta.url).href),import:true},'framer-motion':{get:()=>()=>__federation_import(new URL('__federation_shared_framer-motion-BRYvnGOy.js', import.meta.url).href),import:true}};
