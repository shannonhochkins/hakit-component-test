...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-zNDpJqfJ.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-CRZoeubB.js', import.meta.url).href),import:true},'@hakit/components':{get:()=>()=>__federation_import(new URL('__federation_shared_@hakit/components-0eBP2cim.js', import.meta.url).href),import:true},'uuid':{get:()=>()=>__federation_import(new URL('__federation_shared_uuid-dw_93kd-.js', import.meta.url).href),import:true},'framer-motion':{get:()=>()=>__federation_import(new URL('__federation_shared_framer-motion-B5Nf_3tg.js', import.meta.url).href),import:true}};
